...
- (void)startListening:(CDVInvokedUrlCommand*)command
{
    [self.commandDelegate runInBackground:^{
        ...
        __block NSString *lastResult = [[NSMutableString alloc] init];
        ...
        self.bufferTask = [self.bufferRec recognitionTaskWithRequest:self.bufferRequest resultHandler:^(SFSpeechRecognitionResult * _Nullable result, NSError * _Nullable error) {
            ...
            if (result != nil) {
                ...
                text = [result.bestTranscription.formattedString stringByReplacingOccurrencesOfString:lastResult withString:@""];
